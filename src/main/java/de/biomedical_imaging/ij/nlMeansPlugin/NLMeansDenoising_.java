...
//            return -1;
//        }
        constantSigma = 15;//(int)gd.getNextNumber();
        smoothingFactor = 1;//(int)gd.getNextNumber();
        autoEstimate = true; //gd.getNextBoolean();
        usedSigmas = new int[imp.getNSlices()*imp.getNFrames()];
        
        //return IJ.setupDialog(imp, DOES_ALL+FINAL_PROCESSING);
        return 0;//J.setupDialog(imp, FINAL_PROCESSING);
    }
